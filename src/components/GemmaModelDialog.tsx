      ...
      <AnimatePresence>
        {isOpen && (
          <Dialog.Portal forceMount>
            <Dialog.Overlay className="fixed inset-0 bg-black/35 z-[220]" />
            ...
            <Dialog.Content asChild onOpenAutoFocus={(event) => event.preventDefault()}>
              <motion.div
                ...
                className="fixed left-[max(0.75rem,calc((100vw-1200px)/2+56px))] top-[58px] z-[230] w-[calc(100vw-28px)] max-w-[430px] transform-gpu outline-none will-change-transform"
              >
