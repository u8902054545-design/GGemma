      ...
      {isOpen && (
        ...
        >
          ...
          <header className="sticky top-0 z-10 flex h-[64px] items-center border-b border-[var(--md-sys-color-outline-variant)]/25 bg-[var(--md-sys-color-background)]/90 px-3 backdrop-blur-md">
            ...
            <h1 className="ml-2 text-lg font-medium text-[var(--md-sys-color-on-surface)]">
              All models
            </h1>
          </header>
          ...
          <main className="flex-1 overflow-y-auto px-4 pb-8 pt-5">
            <div className="mx-auto w-full max-w-[720px] space-y-6">
              ...
              {/* Block 1: Gemini models (Empty for now, without icon) */}
              <div>
                <button
                  type="button"
                  className="mb-3 flex items-center gap-2 rounded-full px-3 py-1.5 text-lg font-semibold text-[var(--md-sys-color-on-surface)] transition-colors hover:bg-[var(--md-sys-color-on-surface-variant)]/10"
                >
                  <span>Gemini models</span>
                </button>

                <div className="flex h-24 items-center justify-center rounded-[24px] border border-dashed border-[var(--md-sys-color-outline-variant)]/30 bg-[var(--md-sys-color-surface-container-low)]/40 px-4 text-center text-sm text-[var(--md-sys-color-on-surface-variant)]/60">
                  No models available in this section yet
                </div>
              </div>

              {/* Block 2: Gemma models (Below header level, with Gemma icon) */}
              <div>
                <button
                  type="button"
                  className="mb-3 flex items-center gap-2.5 rounded-full px-3 py-1.5 text-lg font-semibold text-[var(--md-sys-color-on-surface)] transition-colors hover:bg-[var(--md-sys-color-on-surface-variant)]/10"
                >
                ...
                <div className="mb-4 rounded-[28px] border border-[var(--md-sys-color-outline-variant)]/25 bg-[var(--md-sys-color-surface-container-high)] p-5 shadow-sm transition-all">
                    ...
                    <div className="flex items-center gap-3.5 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-0.5 text-xs text-[var(--md-sys-color-on-surface-variant)] leading-relaxed">
                          Optimal model selection for each prompt
                        </p>
                      </div>
                    </div>
                  ...
                  {isAutoSelect && (
                    ...
                    >
                      ...
                      <span>Automatic selection is active. The system will automatically select the best Gemma model for your prompt.</span>
                    </motion.div>
                  )}
                </div>

                {/* Gemma Models List (Only rendered when Auto Select is OFF) */}
